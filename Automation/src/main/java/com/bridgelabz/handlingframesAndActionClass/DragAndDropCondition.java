...
public class DragAndDropCondition {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement drag2 = driver.findElement(By.xpath("//h1[contains(text(),'Block 3')]"));
		Thread.sleep(3000);
		Actions action=new Actions(driver);
		action.dragAndDropBy(drag1, drag2.getLocation().getX()+10,drag2.getSize().getHeight()+10).perform();
